...
useEffect(()=>{
  ...
  return (
      ...
      <span className="text-gray-500">Please provide your name, email address, and phone number.</span>
        ...
        <FormInput label={'Name'} type={'text'} placeholder={'your name...'} name={'name'}/>
        <FormInput label={'Email Address'} type={'email'} placeholder={'your email...'} name={'email'}/>
        <FormInput label={'Phone Number'} type={'text'} placeholder={'your phone number...'} name={'phone'}/>
        <div>
